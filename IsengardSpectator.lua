...
--TODO Отображать тултипы на иконках аур и кулдаунов
--TODO Ошибка альфы иконки класса (не наследуется от основного фрейма)
--TODO Ошибка отсутствия иконки спека на нижних фреймах
